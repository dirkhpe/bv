...
if __name__ == "__main__":
    ...
    SELECT {fields}
    FROM {table} t1
    INNER JOIN server ON server.id = t1.serverId
    INNER JOIN soft ON soft.id = t1.softId
